...
Do not be afraid to experiment with different settings of the software, which we are going to explore in the [4th chapter](photogrammetry-software). With small objects, you can always go back one step and try again.
